...
class SearchRepositoryImpl @Inject constructor(
    ...
    override suspend fun getSearchViewsList(): Result<List<InternshipAnnouncementModel>> = runCatching {
        searchDataSource.getSearchViews().result.toSearchViewsEntity()
    }

    override suspend fun getSearchScrapsList(): Result<List<InternshipAnnouncementModel>> = runCatching {
